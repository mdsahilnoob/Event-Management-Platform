...
export default function Home() {
  ...
  return (
    <div className={inter.className}>
      ...
      >
        <section className="flex flex-col w-full mx-16 h-screen mb-10">
          <Navbar />
          <div className="flex gap-24">
            <div className="flex flex-col w-[60vw] gap-10">
              <div className=" border-dark dark:border-light border-2 gap-8 h-full flex flex-col items-center justify-center">
                <h1 className="uppercase text-7xl tracking-[24px]">Ibento</h1>
              ...
              <button className="uppercase h-32 text-dark bg-light_tert dark:bg-light p-4">
                <div className="w-full h-full border-4 text-2xl tracking-[18px] border-dark flex justify-center items-center hover:gap-2 transition ease-in duration-100">
                  Get in touch
                  <AiOutlineArrowRight />
                </div>
              </button>
